...
The Alfanumrik /v2 contract. Single source of truth: packages/lib/src/api/v2/contract.ts (Zod). This document is generated by `npm run gen:openapi` and consumed by the Dart client codegen (`npm run gen:dart`). Do not edit by hand.
...
try {
    final response = await api.getExamSchedule();
    print(response);
...
------------ | ------------- | ------------- | -------------
[*ExamScheduleApi*](doc/ExamScheduleApi.md) | [**getExamSchedule**](doc/ExamScheduleApi.md#getexamschedule) | **GET** /v2/exam-schedule | Three-tier exam schedule for the authenticated student
...
## Documentation For Models
 ...
 - [ExamReadinessBand](doc/ExamReadinessBand.md)
 - [ExamScheduleEntry](doc/ExamScheduleEntry.md)
 - [ExamScheduleEntryTopic](doc/ExamScheduleEntryTopic.md)
 - [ExamScheduleResponse](doc/ExamScheduleResponse.md)
 - [LeaderboardEntry](doc/LeaderboardEntry.md)
 - [LeaderboardResponse](doc/LeaderboardResponse.md)
 - [LeaderboardSelf](doc/LeaderboardSelf.md)
 ...
 - [SubjectNotAllowedDetails](doc/SubjectNotAllowedDetails.md)
