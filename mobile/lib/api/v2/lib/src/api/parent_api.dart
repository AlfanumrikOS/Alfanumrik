...
class ParentApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ParentChildrenResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ParentChildrenResponse>> getParentChildren({ 
    ...
    final _path = r'/v2/parent/children';
    ...
    ParentChildrenResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ParentChildrenResponse),
      ) as ParentChildrenResponse;
    ...
    return Response<ParentChildrenResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ParentGlanceResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ParentGlanceResponse>> getParentGlance({ 
    ...
    final _path = r'/v2/parent/glance';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'student_id': encodeQueryParameter(_serializers, studentId, const FullType(String)),
    };
    ...
    ParentGlanceResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ParentGlanceResponse),
      ) as ParentGlanceResponse;
    ...
    return Response<ParentGlanceResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SuccessAck] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SuccessAck>> postParentEncourage({ 
    EncourageRequest? encourageRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v2/parent/encourage';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(EncourageRequest);
      _bodyData = encourageRequest == null ? null : _serializers.serialize(encourageRequest, specifiedType: _type);
    ...
    SuccessAck? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SuccessAck),
      ) as SuccessAck;
