...
class TodayApi {
  ...
  const TodayApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TodayResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TodayResponse>> getToday({ 
    ...
    TodayResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TodayResponse),
      ) as TodayResponse;
