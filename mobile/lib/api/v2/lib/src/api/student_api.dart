...
class StudentApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [LeaderboardResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LeaderboardResponse>> getStudentLeaderboard({ 
    String? period,
    String? scope,
    ...
    final _path = r'/v2/student/leaderboard';
    ...
    LeaderboardResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(LeaderboardResponse),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StudentProfileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StudentProfileResponse>> getStudentProfile({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v2/student/profile';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StudentProfileResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(StudentProfileResponse),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StudentProgressResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StudentProgressResponse>> getStudentProgress({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v2/student/progress';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StudentProgressResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(StudentProgressResponse),
      ) as StudentProgressResponse;
    ...
    return Response<StudentProgressResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
