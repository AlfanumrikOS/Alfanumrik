...
class ExamScheduleApi {
  ...
  const ExamScheduleApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ExamScheduleResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExamScheduleResponse>> getExamSchedule({ 
    ...
    final _path = r'/v2/exam-schedule';
    ...
    ExamScheduleResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ExamScheduleResponse),
      ) as ExamScheduleResponse;
    ...
    return Response<ExamScheduleResponse>(
      data: _responseData,
