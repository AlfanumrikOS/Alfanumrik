...
const PUBLIC_PAGES = [
  ...
  { path: '/careers', label: 'Careers', mustContain: ['Careers', 'careers@alfanumrik.com'] },
  { path: '/contact', label: 'Contact', mustContain: ['Contact'] },
  { path: '/pricing', label: 'Pricing', mustContain: ['Plan', 'Pricing'] },
  { path: '/press', label: 'Press', mustContain: ['Press', 'press@alfanumrik.com'] },
  { path: '/privacy', label: 'Privacy Policy', mustContain: ['Privacy'] },
  { path: '/refunds', label: 'Refunds', mustContain: ['Refunds', 'Refund policy'] },
