...
| 4 | **Foxy AI Tutor & RAG** | P12, P8 | High | **IN PROGRESS — NEXT** | ai-engineer (lead) + assessment | Core differentiator. Age-appropriateness, CBSE-scope lock, daily limits, NCERT-grounded retrieval, no PII to LLM. Safety + cost exposure. |
