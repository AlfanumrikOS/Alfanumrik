...
const EMBED_NCERT_QA_ROUTE_PROFILE = createStaticAiRouteProfile({
  route: 'embed-ncert-qa',
...
Deno.serve(async (req: Request) => {
  ...
  if (req.method !== 'GET' && req.method !== 'POST') {
    ...
    const admitResult = await admitAiRoute({ req, sb, profile: EMBED_NCERT_QA_ROUTE_PROFILE, bodyText: '' })
