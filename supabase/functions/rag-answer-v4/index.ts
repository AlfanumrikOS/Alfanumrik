/**
 * TOMBSTONE — rag-answer-v4 retired 2026-08-31.
 *
 ...
 * Permanent deletion (`supabase functions delete rag-answer-v4`) is a
...
serve((req) => {
  ...
  console.warn(`[rag-answer-v4:tombstone] method=${req.method} ua="${userAgent}"`)

  return new Response(
    JSON.stringify({
      code: 'GONE',
      error: `The rag-answer-v4 Edge Function was retired on ${RETIRED_ON}. It had zero application callers. Use grounded-answer instead.`,
    }),
    {
      status: 410,
