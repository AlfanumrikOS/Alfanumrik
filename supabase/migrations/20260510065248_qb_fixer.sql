...
-- Intentional no-op (Phase E.2 lint allow-list): canonical qb_fixer DDL lives
-- in 20260510064952_qb_fixer.sql. This file only exists to satisfy the Supabase
-- CLI's local↔remote match for the MCP-generated timestamp.
--
