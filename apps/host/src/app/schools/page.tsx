...
import { LangProvider, LangToggle, useLang } from '@alfanumrik/ui/landing/LangToggle';
import {
...
const FEATURES = [
  {
    ...
    desc: 'AI-powered Foxy for every student, adapting to their pace and learning style.',
    descHi: 'हर छात्र के लिए AI-संचालित Foxy, उनकी गति और सीखने की शैली के अनुसार।',
  },
  {
