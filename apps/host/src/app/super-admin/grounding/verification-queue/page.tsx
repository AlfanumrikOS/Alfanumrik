                  ...
                  <tr key={f.id}>
                    ...
                    <td className={TD}>
                      ...
                      <button
                        ...
                        disabled={pending !== null}
                        className={`rounded-md border border-danger bg-transparent px-2.5 py-1 text-xs font-medium text-danger hover:bg-[color-mix(in_srgb,var(--danger)_10%,transparent)] ${
                          pending !== null ? 'cursor-not-allowed opacity-40' : ''
                        }`}
