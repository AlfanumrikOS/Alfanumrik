 ...
 *
 * New code should import from '@alfanumrik/ui/admin-ui/StatusBadge' directly.
 */

export { StatusBadge, type StatusBadgeProps, type StatusBadgeVariant } from '@alfanumrik/ui/admin-ui/StatusBadge';
export { default } from '@alfanumrik/ui/admin-ui/StatusBadge';
