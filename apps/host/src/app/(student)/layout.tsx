...
export default function StudentLayout({ children }: { children: React.ReactNode }) {
  ...
  if (denied || !enabled || !manifest || activeRole !== 'student') return <DataState state="permission" title="This learning destination is unavailable" />;
  if (!routeMapped) return <>{children}</>;
