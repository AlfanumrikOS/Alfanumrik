...
import { SimErrorBoundary } from '@alfanumrik/ui/simulations/SimulationShell';
import { useRouter } from 'next/navigation';
import { useAuth } from '@alfanumrik/lib/AuthContext';
import { supabase } from '@alfanumrik/lib/supabase';
import { BUILT_IN_SIMULATIONS, type BuiltInSimulation } from '@alfanumrik/ui/simulations/index';
import type { ExperimentResult } from '@alfanumrik/ui/stem/GuidedExperiment';
import { getExperimentForSimulation } from '@alfanumrik/ui/stem/experiments';
import { isPremium } from '@alfanumrik/lib/plans';
...
const GuidedExperiment = dynamic(() => import('@alfanumrik/ui/stem/GuidedExperiment'), {
  ssr: false,
...
const ExperimentCelebration = dynamic(
  () => import('@alfanumrik/ui/stem/ExperimentCelebration'),
  { ssr: false },
);

import type { ExperimentCelebrationResult } from '@alfanumrik/ui/stem/ExperimentCelebration';
