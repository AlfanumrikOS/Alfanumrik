...
const buttonStyle: React.CSSProperties = { display: 'inline-block', width: '100%', padding: '14px 20px', background: 'linear-gradient(135deg, var(--orange), #F5A623)', color: 'var(--text-1)', border: 'none', borderRadius: 12, fontSize: 15, fontWeight: 600, cursor: 'pointer', textDecoration: 'none', transition: 'all 0.2s ease', marginBottom: 16 };
