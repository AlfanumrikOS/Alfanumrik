 ...
 * consolidated nav (ConsolidatedSchoolNav.tsx) replaced it with '/school-admin/audit-log'.
 * Safe to delete only once analytics confirm zero hits over a full quarter.
 */
import { redirect } from 'next/navigation';
export default function SchoolGovernancePage() { redirect('/school-admin/audit-log'); }
