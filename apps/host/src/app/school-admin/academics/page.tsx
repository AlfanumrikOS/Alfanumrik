 ...
 * consolidated nav (ConsolidatedSchoolNav.tsx) replaced it with '/school-admin/classes'.
 * Safe to delete only once analytics confirm zero hits over a full quarter.
 */
import { redirect } from 'next/navigation';
export default function SchoolAcademicsPage() { redirect('/school-admin/classes'); }
