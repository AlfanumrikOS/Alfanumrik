 ...
 * consolidated nav (ConsolidatedSchoolNav.tsx) replaced it with '/school-admin/reports'.
 * Safe to delete only once analytics confirm zero hits over a full quarter.
 */
import { redirect } from 'next/navigation';
export default function SchoolInsightsPage() { redirect('/school-admin/reports'); }
