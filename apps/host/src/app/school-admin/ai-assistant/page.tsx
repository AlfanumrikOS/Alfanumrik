...
import { useSchoolAdminRole } from '@alfanumrik/lib/use-school-admin-role';
import { Card, Skeleton } from '@alfanumrik/ui/ui';
...
const PrincipalAiChat = dynamic(
  () => import('@alfanumrik/ui/school-admin/principal-ai/PrincipalAiChat'),
  {
    ssr: false,
    loading: () => (
