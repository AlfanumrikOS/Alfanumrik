...
vi.mock('@alfanumrik/lib/state/subscribers/dispatcher', async () => {
  const actual = await vi.importActual<typeof import('@alfanumrik/lib/state/subscribers/dispatcher')>(
    '@alfanumrik/lib/state/subscribers/dispatcher',
  );
  return {
    ...actual,
    standardDispatcher: {
