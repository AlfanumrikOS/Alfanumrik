...
import { type MathPipelineResult } from '@alfanumrik/lib/ai/math/solve-pipeline';
import { type CurriculumScopeResult } from '@alfanumrik/lib/foxy/curriculum-scope';
import {
  extractExpectation,
  writeExpectation,
...
// `@alfanumrik/lib/ai/math/solve-pipeline` so the P12-critical fail-closed mapping can be
