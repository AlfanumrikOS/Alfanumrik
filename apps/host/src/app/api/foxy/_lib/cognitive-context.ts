 ...
 * builder + types come from `@alfanumrik/lib/learn/build-twin-context`; chapter parsing
 * comes from `@alfanumrik/lib/foxy/chapter-parser`; the pending-expectation type comes
 * from `@alfanumrik/lib/learn/foxy-expectations` — this module imports rather than
 * redefines.
 */
