...
import { BUILT_IN_SIMULATIONS_META, type BuiltInSimulationMeta } from '@alfanumrik/ui/simulations/metadata';
import { GUIDED_EXPERIMENTS } from '@alfanumrik/ui/stem/experiments';
