 ...
 *
 *   - @alfanumrik/lib/monitoring/log-event   → logLearningEvent / logSystemMetric /
 *                                    generateCorrelationId (the telemetry WRITE
 *                                    + correlation-id surface). This is what the
 *                                    module imports directly.
 *   - @alfanumrik/lib/feature-flags          → isFeatureEnabled (the master flag gate that
 ...
 *   - @alfanumrik/lib/supabase-admin         → a chained builder used for question_bank +
 ...
 *   - @alfanumrik/lib/logger                 → logger.debug (SPEC-3 emits a debug line on a
...
// ─── @alfanumrik/lib/monitoring/log-event ──────────────────────────────────────────────
...
// ─── @alfanumrik/lib/supabase-admin (chained builder) ──────────────────────────────────
