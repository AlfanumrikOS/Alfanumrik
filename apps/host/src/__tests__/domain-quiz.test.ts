...
// ── Mock scoring ──────────────────────────────────────────────────────────────
vi.mock('@alfanumrik/lib/scoring', () => ({
...
let fetchQuizQuestions: (typeof import('@alfanumrik/lib/domains/quiz'))['fetchQuizQuestions'];
let submitQuizSession:  (typeof import('@alfanumrik/lib/domains/quiz'))['submitQuizSession'];
...
beforeEach(async () => {
  ...
  const mod = await import('@alfanumrik/lib/domains/quiz');
  fetchQuizQuestions = mod.fetchQuizQuestions;
  submitQuizSession  = mod.submitQuizSession;

  const logMod = await import('@alfanumrik/lib/logger');
