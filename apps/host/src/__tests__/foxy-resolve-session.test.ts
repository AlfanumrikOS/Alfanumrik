...
vi.mock('@alfanumrik/lib/grounding-config', () => ({
...
vi.mock('@alfanumrik/lib/tenant-domain', () => ({
  coerceTenantType: vi.fn(),
}));
vi.mock('@alfanumrik/lib/ai/prompts/tenant-overrides', () => ({
  buildTenantOverrideSection: vi.fn(),
}));
vi.mock('@alfanumrik/lib/foxy/schema', () => ({
...
vi.mock('@alfanumrik/lib/goals/goal-personas', () => ({
  buildExpandedGoalSection: vi.fn(),
}));
vi.mock('@alfanumrik/lib/foxy/recent-lab-context', () => ({
  fetchRecentLabContext: vi.fn(),
}));
vi.mock('@alfanumrik/lib/foxy/foxy-lab-prompt', () => ({
  buildLabContextSection: vi.fn(),
}));
vi.mock('@alfanumrik/lib/state/context/foxy-context-bridge', () => ({
