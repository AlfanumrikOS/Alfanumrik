...
import { speak, startListening } from '@alfanumrik/lib/voice';
import { PythonVoiceError } from '@alfanumrik/lib/voice-python-client';
...
vi.mock('@alfanumrik/lib/voice-python-client', async () => {
  const actual = await vi.importActual<typeof import('@alfanumrik/lib/voice-python-client')>(
    '@alfanumrik/lib/voice-python-client',
  );
  return {
    ...actual,
...
import { synthesizePython, transcribePython } from '@alfanumrik/lib/voice-python-client';
