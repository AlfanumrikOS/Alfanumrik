...
import { getScoreColor, getQuizScoreColor } from '@alfanumrik/lib/score-colors';
import { getScoreColor as getScoreColorReExport } from '@alfanumrik/ui/score/ScoreCard';
 ...
 *   4. The back-compat re-export from `@alfanumrik/ui/score/ScoreCard` is the
...
describe('getScoreColor — back-compat re-export', () => {
  it('@alfanumrik/ui/score/ScoreCard re-exports the identical function', () => {
