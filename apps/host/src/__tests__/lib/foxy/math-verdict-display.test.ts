 ...
 *   pure, side-effect-free module `@alfanumrik/lib/ai/math/solve-pipeline`
 ...
 *     - `@alfanumrik/lib/ai/math/solve-math`     (solveMath — reasoning-cascade generation)
 *     - `@alfanumrik/lib/math-python-client`     (verifyMath — SymPy verifier)
...
vi.mock('@alfanumrik/lib/ai/math/solve-math', () => ({
  solveMath: (...args: unknown[]) => _solveMath(...args),
}));
vi.mock('@alfanumrik/lib/math-python-client', () => ({
