...
describe('Indian market features', () => {
  ...
  describe('Offline Store', () => {
    it('caches and retrieves data', async () => {
      const { cacheSet, cacheGet } = await import('@alfanumrik/lib/offlineStore');
    ...
    it('returns null for expired data', async () => {
      const { cacheGet } = await import('@alfanumrik/lib/offlineStore');
    ...
    it('queues offline actions', async () => {
      const { queueOfflineAction, getOfflineQueue, clearOfflineQueue } = await import('@alfanumrik/lib/offlineStore');
  ...
  describe('WhatsApp Share', () => {
    it('generates Hindi quiz share message', async () => {
      const { quizShareMessage } = await import('@alfanumrik/lib/share');
    ...
    it('generates streak share message', async () => {
      const { streakShareMessage } = await import('@alfanumrik/lib/share');
  ...
  describe('Analytics', () => {
    it('track function does not throw', async () => {
      const { track } = await import('@alfanumrik/lib/analytics');
