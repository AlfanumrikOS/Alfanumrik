...
async function renderMission(
  overrides: Partial<React.ComponentProps<typeof import('@alfanumrik/ui/dashboard/os/TodaysMission').default>> = {},
) {
  const { default: TodaysMission } = await import('@alfanumrik/ui/dashboard/os/TodaysMission');
  return render(
