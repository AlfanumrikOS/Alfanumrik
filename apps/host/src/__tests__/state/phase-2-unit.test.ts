...
vi.mock('@alfanumrik/lib/state/runtime/tick-all', async () => {
  const actual = await vi.importActual<typeof import('@alfanumrik/lib/state/runtime/tick-all')>(
    '@alfanumrik/lib/state/runtime/tick-all',
  );
...
import { StudentStateSchema } from '@alfanumrik/lib/state/student-state';
import { STANDARD_SERVICES, pickServices } from '@alfanumrik/lib/state/services/registry';
import { masteryStateWriter } from '@alfanumrik/lib/state/subscribers/mastery-state-writer';
import {
  createDispatcher,
  standardDispatcher,
  STANDARD_SUBSCRIBERS,
} from '@alfanumrik/lib/state/subscribers/dispatcher';
import { toAnySubscriber, type Subscriber, type SubscriberContext } from '@alfanumrik/lib/state/subscribers/subscriber';
import type { DomainEvent } from '@alfanumrik/lib/state/events/registry';
import { tick } from '@alfanumrik/lib/state/runtime/event-listener';
