...
describe('validatePublicEnv', () => {
  ...
  it('throws when NEXT_PUBLIC_SUPABASE_URL is missing', async () => {
    ...
    const { validatePublicEnv } = await import('@alfanumrik/lib/env');
...
describe('validateServerEnv', () => {
  ...
  it('throws when SUPABASE_SERVICE_ROLE_KEY is missing', async () => {
    ...
    const { validateServerEnv } = await import('@alfanumrik/lib/env');
...
describe('env convenience object', () => {
  ...
  it('exposes NEXT_PUBLIC_SUPABASE_URL', async () => {
    ...
    const { env } = await import('@alfanumrik/lib/env');
