 ...
 *   - The seat-enforcement HELPER module (`@alfanumrik/lib/school-admin/seat-enforcement`)
...
vi.mock('@alfanumrik/lib/school-admin/seat-enforcement', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@alfanumrik/lib/school-admin/seat-enforcement')>();
  return {
...
function verdict(over: Partial<import('@alfanumrik/lib/school-admin/seat-enforcement').SeatVerdict> = {}) {
  return {
    allowed: true,
