 ...
 * business logic): we mock @alfanumrik/lib/supabase-server (RLS read of students) and
 * @alfanumrik/lib/supabase-admin (served-item lookup + claim UPDATE + tutor_commit_attempt
