 ...
 *
 * REG-250 (below): the ARMED keyless Cloud Run invoker-token mint. When
...
// tests (which never reach the import) — that is exactly what REG-250's dormant
...
// ─────────────────────────────────────────────────────────────────────────────
// REG-250 — keyless Vercel-OIDC → GCP-WIF Cloud Run invoker-token mint.
//
...
describe('callPythonMol — keyless WIF Cloud Run invoker mint (REG-250)', () => {
