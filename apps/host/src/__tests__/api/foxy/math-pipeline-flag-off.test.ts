...
vi.mock('@alfanumrik/lib/ai/math/solve-math', () => ({ solveMath: (...args: unknown[]) => _solveMath(...args) }));
vi.mock('@alfanumrik/lib/math-python-client', () => ({ verifyMath: (...args: unknown[]) => _verifyMath(...args) }));
