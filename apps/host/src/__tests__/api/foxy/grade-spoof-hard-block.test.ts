 ...
 *     similar early-gate guard for this route): vi.mock for @alfanumrik/lib/rbac
 *     (authorizeRequest + logAudit), @alfanumrik/lib/feature-flags, @alfanumrik/lib/subjects,
 *     @alfanumrik/lib/logger, @alfanumrik/lib/foxy/math-flag, @alfanumrik/lib/ai/grounded-client,
 *     @alfanumrik/lib/ai (classifyIntent/routeIntent), @alfanumrik/lib/supabase-admin (chained
