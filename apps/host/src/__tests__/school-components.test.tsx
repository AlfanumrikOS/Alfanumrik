...
describe('NotificationCenter', () => {
  ...
  it('renders bell icon without crashing', async () => {
    const { default: NotificationCenter } = await import('@alfanumrik/ui/school/NotificationCenter');
...
describe('SchoolAnnouncementBanner', () => {
  ...
  it('shows skeleton when loading', async () => {
    mockSWRLoading = true;
    const { default: SchoolAnnouncementBanner } = await import('@alfanumrik/ui/school/SchoolAnnouncementBanner');
...
describe('SchoolWelcomeHeader', () => {
  ...
  it('B2B mode shows school name', async () => {
    const { default: SchoolWelcomeHeader } = await import('@alfanumrik/ui/school/SchoolWelcomeHeader');
...
describe('UpcomingExamCard', () => {
  ...
  it('shows skeleton when loading', async () => {
    mockSWRLoading = true;
    const { default: UpcomingExamCard } = await import('@alfanumrik/ui/school/UpcomingExamCard');
