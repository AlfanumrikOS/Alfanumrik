...
- Name: smoke.spec.ts >> Landing Page >> renders audience sections for Students, Parents, Teachers, Schools
- Location: e2e\smoke.spec.ts:98:7
...
Locator: locator('text=For Students')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=For Students')
