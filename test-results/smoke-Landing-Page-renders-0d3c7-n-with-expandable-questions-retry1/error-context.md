...
- Name: smoke.spec.ts >> Landing Page >> renders FAQ section with expandable questions
- Location: e2e\smoke.spec.ts:121:7
...
Locator: locator('text=Frequently Asked Questions').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Frequently Asked Questions').first()
