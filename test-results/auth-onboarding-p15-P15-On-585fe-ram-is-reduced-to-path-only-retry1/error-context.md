...
- Name: auth-onboarding-p15.spec.ts >> P15: Onboarding Integrity >> F: /auth/confirm token_hash flow >> /auth/confirm absolute URL in next param is reduced to path only
- Location: e2e\auth-onboarding-p15.spec.ts:466:9
...
Received string:        "http://localhost:3000/auth/confirm?token_hash=bad&type=signup&next=https%3A%2F%2Fevil.com%2Fsteal%3Fdata%3D1"
```
