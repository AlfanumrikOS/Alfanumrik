...
- Name: public-pages.spec.ts >> Admin routes are protected >> /super-admin redirects to super-admin login
- Location: e2e\public-pages.spec.ts:143:7
...
waiting for navigation until "load"
  navigated to "http://localhost:3000/super-admin"
============================================================
```
