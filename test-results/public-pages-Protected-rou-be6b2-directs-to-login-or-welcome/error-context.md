...
- Name: public-pages.spec.ts >> Protected routes redirect unauthenticated users to login >> /billing redirects to login or welcome
...
waiting for navigation until "load"
  navigated to "http://localhost:3000/billing"
============================================================
```
