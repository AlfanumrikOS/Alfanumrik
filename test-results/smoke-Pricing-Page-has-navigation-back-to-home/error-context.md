...
- Name: smoke.spec.ts >> Pricing Page >> has navigation back to home
- Location: e2e\smoke.spec.ts:278:7
...
Locator: locator('a[href="/welcome"]')
Expected: visible
Error: strict mode violation: locator('a[href="/welcome"]') resolved to 2 elements:
    1) <a href="/welcome">…</a> aka getByRole('link', { name: '🦊 Alfanumrik' })
    2) <a href="/welcome">Home</a> aka getByRole('link', { name: 'Home' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('a[href="/welcome"]')
