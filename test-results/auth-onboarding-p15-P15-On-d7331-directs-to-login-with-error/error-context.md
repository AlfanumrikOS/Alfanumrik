...
- Name: auth-onboarding-p15.spec.ts >> P15: Onboarding Integrity >> F: /auth/confirm token_hash flow >> /auth/confirm with invalid token_hash redirects to /login with error
- Location: e2e\auth-onboarding-p15.spec.ts:424:9
