...
- Name: smoke.spec.ts >> Landing Page >> renders Product Experience section with feature grid
...
Locator: locator('text=Built for how Indian students')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Built for how Indian students')
