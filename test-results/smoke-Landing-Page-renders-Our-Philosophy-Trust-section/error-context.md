...
- Name: smoke.spec.ts >> Landing Page >> renders Our Philosophy / Trust section
- Location: e2e\smoke.spec.ts:115:7
...
Locator: locator('text=OUR PHILOSOPHY')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=OUR PHILOSOPHY')
