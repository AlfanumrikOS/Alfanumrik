...
- Name: smoke.spec.ts >> Landing Page >> renders Outcomes section with result cards
- Location: e2e\smoke.spec.ts:106:7
...
Call log:
  ...
  - waiting for locator('text=OUTCOMES')
