...
- Name: smoke.spec.ts >> Landing Page >> renders The Real Problem section with 4 problem cards
...
Locator: locator('text=Exam stress builds silently')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Exam stress builds silently')
