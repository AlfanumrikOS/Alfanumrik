...
- Name: smoke.spec.ts >> Landing Page >> navigation links are present in navbar
...
Locator: locator('nav').locator('a[href="/product"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav').locator('a[href="/product"]')
