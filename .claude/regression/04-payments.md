...
## setup-plans caller-contract migration — x-admin-secret header gate REMOVED, authorizeAdmin(super_admin) session floor (2026-08-03, P0+P1 batch) — REG-334
...
Pre-REG-334: 333 entries (through REG-333, the `select_quiz_questions_rag`
verification gate — see `00-header.md` / `03-quiz-integrity.md`). The
2026-08-03 P0+P1 batch adds REG-334 (setup-plans caller-contract migration),
the first of the eight ids REG-334..REG-341 consumed by this batch.
