...
## verifyCronAuth consolidation — one fail-closed cron gate, ?token= carrier REMOVED, /api/cron/daily deleted (2026-08-03, P0+P1 batch) — REG-337
...
Pre-REG-337: 336 entries (through REG-336, the usePortalFetch timeout
envelope — see `07-teacher-school.md`). The 2026-08-03 P0+P1 batch adds
REG-337 (verifyCronAuth consolidation + query-carrier removal + dead-alias
