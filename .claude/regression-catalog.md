...
> **ID note:** REG-125 is reserved by an in-flight cluster that has not yet
> landed in this file (orchestrator instruction: "next free ids after
> REG-125"). This cluster therefore takes REG-126..REG-129. Do not reuse
> REG-125.
...
Pre-Loop-A: 92 entries (+ REG-125 reserved out-of-file). Adds REG-126
(closed-loop state machine), REG-127 (cron worker posture), REG-128 (B2B
escalation attribution), REG-129 (student-facing lane). **Total catalog: 96
