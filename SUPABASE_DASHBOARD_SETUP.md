...
## 3. Auth Hooks (Optional - for Resend integration)
...
Then set secrets in **Edge Functions → Secrets**:
- `RESEND_API_KEY` = your Resend API key
- `SEND_EMAIL_HOOK_SECRET` = the secret generated by the hook

---

## 4. Resend Setup (for custom email sending)
1. Go to https://resend.com and create an account
2. Add domain: alfanumrik.com
3. Add DNS records (DKIM, SPF, DMARC) to GoDaddy
4. Get API key from https://resend.com/api-keys
5. Add to Supabase Edge Functions Secrets as RESEND_API_KEY
