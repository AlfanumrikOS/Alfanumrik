...
| `parent.child_erasure_requested` / `_cancelled` / `_completed` | ❌ Removed 2026-08-30 | Phase D.3 (DPDP §15) child-erasure event kinds, removed along with the whole DPDP erasure subsystem — see `supabase/migrations/20260830172610_remove_dpdp_erasure_system.sql`. |
