 ...
 *
 * @deprecated Use useAllowedSubjects() from '@alfanumrik/lib/useAllowedSubjects' instead.
 */
...
function _logSubjectDeprecation(name: string): void {
  ...
  console.warn(
    `[deprecated] ${name} from @alfanumrik/lib/constants is a compat shim; use useAllowedSubjects() instead.`,
  );
}

/** @deprecated Use useAllowedSubjects() from '@alfanumrik/lib/useAllowedSubjects'. */
