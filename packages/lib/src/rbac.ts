...
// types from '@alfanumrik/lib/rbac' continues to work unchanged.
...
export type {
  ...
  AuthorizationResult,
  ResourceAccessCheck,
} from '@alfanumrik/lib/rbac-types';

import type { RoleName, UserPermissions, AuthorizationResult } from '@alfanumrik/lib/rbac-types';
