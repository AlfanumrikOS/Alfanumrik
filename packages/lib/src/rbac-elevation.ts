 ...
 *
 * Usage:
 *   import { grantElevation, revokeElevation, getActiveElevations } from '@alfanumrik/lib/rbac-elevation';
 *
...
import { invalidateForSecurityEvent } from '@alfanumrik/lib/rbac';
