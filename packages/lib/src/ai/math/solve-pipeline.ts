...
import { solveMath } from '@alfanumrik/lib/ai/math/solve-math';
import type { CascadeTier } from '@alfanumrik/lib/ai/clients/reasoning-cascade';
import {
  verifyMath,
  type VerifyMathKind,
  type VerifyMathResult,
} from '@alfanumrik/lib/math-python-client';
