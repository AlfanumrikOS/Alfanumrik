...
// type via `@alfanumrik/lib/ai/grounded-client` for ergonomic colocation with the
// response shape; the runtime/validation lives in `@alfanumrik/lib/foxy/schema`.
export type { FoxyResponse } from '@alfanumrik/lib/foxy/schema';

import type { FoxyResponse as FoxyResponseShape } from '@alfanumrik/lib/foxy/schema';
