 ...
 *
 * Usage:
 *   import { auditLog, AuditAction } from '@alfanumrik/lib/audit';
 *
 *   await auditLog({
...
import type { RoleName } from '@alfanumrik/lib/rbac';
...
export const SCHOOL_AUDIT_ACTIONS = [
  ...
  // Bulk CSV content upload — written by /api/school-admin/content/bulk.
  'content.bulk_uploaded',
] as const;
