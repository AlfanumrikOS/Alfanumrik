...
import { Button, ProgressBar, Skeleton } from '@alfanumrik/ui/ui';
import { calculateLevel, xpToNextLevel, getLevelName, XP_PER_LEVEL } from '@alfanumrik/lib/xp-config';
import type { CmeAction } from '@alfanumrik/lib/types';
