...
import { Card, Button, IconButton, Badge, Alert, MasteryRing } from '@alfanumrik/ui/ui/primitives';
...
const LevelUpModal = dynamic(
  () => import('@alfanumrik/ui/achievements/LevelUpModal'),
  { ssr: false }
);
...
export default function QuizResults({
  ...
  useEffect(() => {
    import('@alfanumrik/lib/sounds').then(({ playSound }) => playSound('complete'));
  }, []);
