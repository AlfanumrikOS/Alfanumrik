 ...
 * │ verbatim so the ~134 existing `@alfanumrik/ui/ui` consumers keep    │
 * │ working byte-for-byte until they are migrated in later phases.    │
 * └──────────────────────────────────────────────────────────────────┘
 *
 * The CANONICAL Phase-2 primitive library lives under
 * `@alfanumrik/ui/ui/primitives`. Its names intentionally collide with the
 ...
 *
 *     import { Button, Card, Badge } from '@alfanumrik/ui/ui/primitives';
 *
