...
import type { AbstainReason, SuggestedAlternative } from '@alfanumrik/ui/foxy/ChatBubble';
import { AlternativesGrid } from '@alfanumrik/ui/grounding/AlternativesGrid';
