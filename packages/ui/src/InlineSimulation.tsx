...
const COMPONENTS: Record<string, React.ComponentType<Record<string, unknown>>> = {
  'builtin-ohms-law': dynamic(() => import('@alfanumrik/ui/simulations/OhmsLaw'), { ssr: false }),
  'builtin-pendulum': dynamic(() => import('@alfanumrik/ui/simulations/PendulumLab'), { ssr: false }),
  'builtin-lens-ray': dynamic(() => import('@alfanumrik/ui/simulations/LensRayDiagram'), { ssr: false }),
  'builtin-wave': dynamic(() => import('@alfanumrik/ui/simulations/WaveOnString'), { ssr: false }),
  'builtin-projectile': dynamic(() => import('@alfanumrik/ui/simulations/ProjectileMotion'), { ssr: false }),
  'builtin-ph-scale': dynamic(() => import('@alfanumrik/ui/simulations/PHScale'), { ssr: false }),
  'builtin-pythagoras': dynamic(() => import('@alfanumrik/ui/simulations/PythagorasTheorem'), { ssr: false }),
  'builtin-fractions': dynamic(() => import('@alfanumrik/ui/simulations/FractionVisualizer'), { ssr: false }),
  'builtin-trig-circle': dynamic(() => import('@alfanumrik/ui/simulations/TrigCircle'), { ssr: false }),
  'builtin-newton-laws': dynamic(() => import('@alfanumrik/ui/simulations/NewtonLaws'), { ssr: false }),
  'builtin-bohr-model': dynamic(() => import('@alfanumrik/ui/simulations/BohrModel'), { ssr: false }),
  'builtin-quadratic-graph': dynamic(() => import('@alfanumrik/ui/simulations/QuadraticGraph'), { ssr: false }),
  'builtin-hookes-law': dynamic(() => import('@alfanumrik/ui/simulations/HookesLaw'), { ssr: false }),
  'builtin-linear-graph': dynamic(() => import('@alfanumrik/ui/simulations/LinearGraph'), { ssr: false }),
  'builtin-chemical-balancer': dynamic(() => import('@alfanumrik/ui/simulations/ChemicalBalancer'), { ssr: false }),
  'builtin-gas-laws': dynamic(() => import('@alfanumrik/ui/simulations/GasLaws'), { ssr: false }),
  'builtin-probability-lab': dynamic(() => import('@alfanumrik/ui/simulations/ProbabilityLab'), { ssr: false }),
  'builtin-snells-law': dynamic(() => import('@alfanumrik/ui/simulations/SnellsLaw'), { ssr: false }),
  'builtin-integration': dynamic(() => import('@alfanumrik/ui/simulations/IntegrationVisualizer'), { ssr: false }),
  'builtin-photosynthesis': dynamic(() => import('@alfanumrik/ui/simulations/PhotosynthesisLab'), { ssr: false }),
  'builtin-human-heart': dynamic(() => import('@alfanumrik/ui/simulations/HumanHeartLab'), { ssr: false }),
};
