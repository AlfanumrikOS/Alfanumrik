...
const REASON_OPTIONS: { value: ReportReasonCategory; en: string; hi: string }[] = [
  ...
  { value: 'off_topic', en: 'Off topic / not from my chapter', hi: 'मेरे अध्याय से नहीं है' },
  { value: 'inappropriate', en: 'Inappropriate or unsafe content', hi: 'गलत या असुरक्षित सामग्री' },
  { value: 'unclear', en: 'Unclear / hard to understand', hi: 'समझना मुश्किल है' },
  { value: 'other', en: 'Other', hi: 'दूसरा' },
];
  ...
  return (
    ...
    >
      <div
        ...
        className="max-h-[calc(100dvh-2rem)] w-full max-w-md overflow-y-auto rounded-2xl bg-white p-5 shadow-xl"
      >
        {success ? (
