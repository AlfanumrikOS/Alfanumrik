...
import { SimulationSkeleton } from '@alfanumrik/ui/Skeleton';
...
const OhmsLaw = dynamic(() => import('./OhmsLaw'), { ssr: false, loading: () => <SimulationSkeleton /> });
const PendulumLab = dynamic(() => import('./PendulumLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const LensRayDiagram = dynamic(() => import('./LensRayDiagram'), { ssr: false, loading: () => <SimulationSkeleton /> });
const WaveOnString = dynamic(() => import('./WaveOnString'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ProjectileMotion = dynamic(() => import('./ProjectileMotion'), { ssr: false, loading: () => <SimulationSkeleton /> });
const PHScale = dynamic(() => import('./PHScale'), { ssr: false, loading: () => <SimulationSkeleton /> });
const PythagorasTheorem = dynamic(() => import('./PythagorasTheorem'), { ssr: false, loading: () => <SimulationSkeleton /> });
const FractionVisualizer = dynamic(() => import('./FractionVisualizer'), { ssr: false, loading: () => <SimulationSkeleton /> });
const TrigCircle = dynamic(() => import('./TrigCircle'), { ssr: false, loading: () => <SimulationSkeleton /> });
const NewtonLaws = dynamic(() => import('./NewtonLaws'), { ssr: false, loading: () => <SimulationSkeleton /> });
const BohrModel = dynamic(() => import('./BohrModel'), { ssr: false, loading: () => <SimulationSkeleton /> });
const QuadraticGraph = dynamic(() => import('./QuadraticGraph'), { ssr: false, loading: () => <SimulationSkeleton /> });
const HookesLaw = dynamic(() => import('./HookesLaw'), { ssr: false, loading: () => <SimulationSkeleton /> });
const LinearGraph = dynamic(() => import('./LinearGraph'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ChemicalBalancer = dynamic(() => import('./ChemicalBalancer'), { ssr: false, loading: () => <SimulationSkeleton /> });
const GasLaws = dynamic(() => import('./GasLaws'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ProbabilityLab = dynamic(() => import('./ProbabilityLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const SnellsLaw = dynamic(() => import('./SnellsLaw'), { ssr: false, loading: () => <SimulationSkeleton /> });
const IntegrationVisualizer = dynamic(() => import('./IntegrationVisualizer'), { ssr: false, loading: () => <SimulationSkeleton /> });
const SymmetryExplorer = dynamic(() => import('./SymmetryExplorer'), { ssr: false, loading: () => <SimulationSkeleton /> });
const AngleExplorer = dynamic(() => import('./AngleExplorer'), { ssr: false, loading: () => <SimulationSkeleton /> });
const BarGraphMaker = dynamic(() => import('./BarGraphMaker'), { ssr: false, loading: () => <SimulationSkeleton /> });
const PhotosynthesisLab = dynamic(() => import('./PhotosynthesisLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const HumanHeartLab = dynamic(() => import('./HumanHeartLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ElectricCircuitBasic = dynamic(() => import('./ElectricCircuitBasic'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MagnetFieldLines = dynamic(() => import('./MagnetFieldLines'), { ssr: false, loading: () => <SimulationSkeleton /> });
const LightReflection = dynamic(() => import('./LightReflection'), { ssr: false, loading: () => <SimulationSkeleton /> });
const CellStructure = dynamic(() => import('./CellStructure'), { ssr: false, loading: () => <SimulationSkeleton /> });
const AcidBaseIndicator = dynamic(() => import('./AcidBaseIndicator'), { ssr: false, loading: () => <SimulationSkeleton /> });
const RefractionLab = dynamic(() => import('./RefractionLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const RespirationLab = dynamic(() => import('./RespirationLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MagneticFieldElectric = dynamic(() => import('./MagneticFieldElectric'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MeterBridgeLab = dynamic(() => import('./MeterBridgeLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ConvexLensLab = dynamic(() => import('./ConvexLensLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const PotentiometerLab = dynamic(() => import('./PotentiometerLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MitosisLab = dynamic(() => import('./MitosisLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const PunnettSquareLab = dynamic(() => import('./PunnettSquareLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const DNAReplicationLab = dynamic(() => import('./DNAReplicationLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const AcidBaseTitration = dynamic(() => import('./AcidBaseTitration'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ElectronConfiguration = dynamic(() => import('./ElectronConfiguration'), { ssr: false, loading: () => <SimulationSkeleton /> });
const StatesOfMatter = dynamic(() => import('./StatesOfMatter'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ElectrochemicalCell = dynamic(() => import('./ElectrochemicalCell'), { ssr: false, loading: () => <SimulationSkeleton /> });
const VectorAddition = dynamic(() => import('./VectorAddition'), { ssr: false, loading: () => <SimulationSkeleton /> });
const SetTheoryVenn = dynamic(() => import('./SetTheoryVenn'), { ssr: false, loading: () => <SimulationSkeleton /> });
const StatisticsLab = dynamic(() => import('./StatisticsLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const CircuitBuilder = dynamic(() => import('./CircuitBuilder'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MagneticField = dynamic(() => import('./MagneticField'), { ssr: false, loading: () => <SimulationSkeleton /> });
const WaveInterference = dynamic(() => import('./WaveInterference'), { ssr: false, loading: () => <SimulationSkeleton /> });
const CoulombsLaw = dynamic(() => import('./CoulombsLaw'), { ssr: false, loading: () => <SimulationSkeleton /> });
const SoundWaves = dynamic(() => import('./SoundWaves'), { ssr: false, loading: () => <SimulationSkeleton /> });

// ── 65 new simulations ────────────────────────────────────────────────────
// Physics 6-8
const SimpleMachines = dynamic(() => import('./SimpleMachines'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MirrorReflection = dynamic(() => import('./MirrorReflection'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ElectricCharge = dynamic(() => import('./ElectricCharge'), { ssr: false, loading: () => <SimulationSkeleton /> });
const HeatTransfer = dynamic(() => import('./HeatTransfer'), { ssr: false, loading: () => <SimulationSkeleton /> });
const SpeedDistanceTime = dynamic(() => import('./SpeedDistanceTime'), { ssr: false, loading: () => <SimulationSkeleton /> });
const LightRefraction = dynamic(() => import('./LightRefraction'), { ssr: false, loading: () => <SimulationSkeleton /> });
const SolarSystem = dynamic(() => import('./SolarSystem'), { ssr: false, loading: () => <SimulationSkeleton /> });
const WeatherCycle = dynamic(() => import('./WeatherCycle'), { ssr: false, loading: () => <SimulationSkeleton /> });
const EchoAndSound = dynamic(() => import('./EchoAndSound'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ShadowFormation = dynamic(() => import('./ShadowFormation'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Physics 9-12
const ElectricMotor = dynamic(() => import('./ElectricMotor'), { ssr: false, loading: () => <SimulationSkeleton /> });
const Transformer = dynamic(() => import('./Transformer'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ResistorsInSeries = dynamic(() => import('./ResistorsInSeries'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ConcaveMirrorLab = dynamic(() => import('./ConcaveMirrorLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ConvexLens = dynamic(() => import('./ConvexLens'), { ssr: false, loading: () => <SimulationSkeleton /> });
const FreeBodyDiagram = dynamic(() => import('./FreeBodyDiagram'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ArchimedesPrinciple = dynamic(() => import('./ArchimedesPrinciple'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ElectromagneticSpectrum = dynamic(() => import('./ElectromagneticSpectrum'), { ssr: false, loading: () => <SimulationSkeleton /> });
const CapacitorCharging = dynamic(() => import('./CapacitorCharging'), { ssr: false, loading: () => <SimulationSkeleton /> });
const DopplerEffect = dynamic(() => import('./DopplerEffect'), { ssr: false, loading: () => <SimulationSkeleton /> });
const YoungDoubleSlitLab = dynamic(() => import('./YoungDoubleSlitLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const NuclearDecay = dynamic(() => import('./NuclearDecay'), { ssr: false, loading: () => <SimulationSkeleton /> });
const PhotoelectricEffect = dynamic(() => import('./PhotoelectricEffect'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Chemistry 6-8
const ElementClassifier = dynamic(() => import('./ElementClassifier'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MixturesSeparation = dynamic(() => import('./MixturesSeparation'), { ssr: false, loading: () => <SimulationSkeleton /> });
const WaterElectrolysis = dynamic(() => import('./WaterElectrolysis'), { ssr: false, loading: () => <SimulationSkeleton /> });
const LitmusTest = dynamic(() => import('./LitmusTest'), { ssr: false, loading: () => <SimulationSkeleton /> });
const AtomBuilder = dynamic(() => import('./AtomBuilder'), { ssr: false, loading: () => <SimulationSkeleton /> });
const PeriodicTrends = dynamic(() => import('./PeriodicTrends'), { ssr: false, loading: () => <SimulationSkeleton /> });
const CrystallizationLab = dynamic(() => import('./CrystallizationLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const RustingExperiment = dynamic(() => import('./RustingExperiment'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Chemistry 9-10
const MolarityCalculator = dynamic(() => import('./MolarityCalculator'), { ssr: false, loading: () => <SimulationSkeleton /> });
const ExothermicEndothermic = dynamic(() => import('./ExothermicEndothermic'), { ssr: false, loading: () => <SimulationSkeleton /> });
const IonicCovalentBonds = dynamic(() => import('./IonicCovalentBonds'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MetalReactivitySeries = dynamic(() => import('./MetalReactivitySeries'), { ssr: false, loading: () => <SimulationSkeleton /> });
const CarbonAllotropes = dynamic(() => import('./CarbonAllotropes'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Chemistry 11-12
const ChemicalKinetics = dynamic(() => import('./ChemicalKinetics'), { ssr: false, loading: () => <SimulationSkeleton /> });
const BufferSolution = dynamic(() => import('./BufferSolution'), { ssr: false, loading: () => <SimulationSkeleton /> });
const GalvanicCell = dynamic(() => import('./GalvanicCell'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MolecularGeometry = dynamic(() => import('./MolecularGeometry'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Biology 6-8
const FoodWeb = dynamic(() => import('./FoodWeb'), { ssr: false, loading: () => <SimulationSkeleton /> });
const HumanDigestiveSystem = dynamic(() => import('./HumanDigestiveSystem'), { ssr: false, loading: () => <SimulationSkeleton /> });
const PlantParts = dynamic(() => import('./PlantParts'), { ssr: false, loading: () => <SimulationSkeleton /> });
const AlveoliBreathingLab = dynamic(() => import('./AlveoliBreathingLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const SeedGermination = dynamic(() => import('./SeedGermination'), { ssr: false, loading: () => <SimulationSkeleton /> });
const AnimalClassification = dynamic(() => import('./AnimalClassification'), { ssr: false, loading: () => <SimulationSkeleton /> });
const WaterPurification = dynamic(() => import('./WaterPurification'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Biology 9-10
const HeartCirculation = dynamic(() => import('./HeartCirculation'), { ssr: false, loading: () => <SimulationSkeleton /> });
const NervousSystem = dynamic(() => import('./NervousSystem'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MeiosisStages = dynamic(() => import('./MeiosisStages'), { ssr: false, loading: () => <SimulationSkeleton /> });
const EcosystemBalance = dynamic(() => import('./EcosystemBalance'), { ssr: false, loading: () => <SimulationSkeleton /> });
const EvolutionTree = dynamic(() => import('./EvolutionTree'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Biology 11-12
const ProteinSynthesis = dynamic(() => import('./ProteinSynthesis'), { ssr: false, loading: () => <SimulationSkeleton /> });
const HormoneRegulation = dynamic(() => import('./HormoneRegulation'), { ssr: false, loading: () => <SimulationSkeleton /> });
const GeneExpression = dynamic(() => import('./GeneExpression'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Math 6-8
const FractionOperations = dynamic(() => import('./FractionOperations'), { ssr: false, loading: () => <SimulationSkeleton /> });
const AreaPerimeter = dynamic(() => import('./AreaPerimeter'), { ssr: false, loading: () => <SimulationSkeleton /> });
const NumberLine = dynamic(() => import('./NumberLine'), { ssr: false, loading: () => <SimulationSkeleton /> });
const SymmetryLinesLab = dynamic(() => import('./SymmetryLinesLab'), { ssr: false, loading: () => <SimulationSkeleton /> });
const DataHandling = dynamic(() => import('./DataHandling'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Math 9-10
const CoordinateGeometry = dynamic(() => import('./CoordinateGeometry'), { ssr: false, loading: () => <SimulationSkeleton /> });
const SurfaceAreaVolume = dynamic(() => import('./SurfaceAreaVolume'), { ssr: false, loading: () => <SimulationSkeleton /> });
const CircleTheorems = dynamic(() => import('./CircleTheorems'), { ssr: false, loading: () => <SimulationSkeleton /> });
// Math 11-12
const LimitsVisualizer = dynamic(() => import('./LimitsVisualizer'), { ssr: false, loading: () => <SimulationSkeleton /> });
const MatrixOperations = dynamic(() => import('./MatrixOperations'), { ssr: false, loading: () => <SimulationSkeleton /> });
