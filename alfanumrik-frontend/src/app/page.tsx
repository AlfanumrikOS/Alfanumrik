...
<div style={{marginTop:32}}><CertBadges size="sm" theme="dark"/></div>
<p style={{fontSize:11,color:'rgba(255,255,255,.25)',marginTop:16}}>{'\u00A9'} 2026 CusioSense Learning India Private Limited</p>
</div>
</div>)}
// ═══════════════════════════════════════════════════════
// PARENT PORTAL
