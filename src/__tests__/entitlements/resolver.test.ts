 ...
 *   - @/lib/supabase-admin  → a per-table chained builder; each test injects the
 ...
 *   - @/lib/feature-flags   → isFeatureEnabled spy (the ENFORCEMENT flag gate).
 *   - @/lib/logger          → silenced (the resolver logs warnings on DB errors).
 *
