...
import type { StartQuizAction } from '@/lib/state/learner-loop/types';
import type { DomainEvent } from '@/lib/state/events/registry';
import { scheduledActionsWriter } from '@/lib/state/subscribers/scheduled-actions-writer';
import type { SubscriberContext } from '@/lib/state/subscribers/subscriber';
...
vi.mock('@/lib/posthog/server', () => ({ capture: vi.fn(async () => {}) }));
vi.mock('@/lib/logger', () => ({
