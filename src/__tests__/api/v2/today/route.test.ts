...
vi.mock('@/lib/state/learner-loop/resolve-next-action', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/lib/state/learner-loop/resolve-next-action')>();
