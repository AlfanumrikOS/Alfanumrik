 ...
 *
 * Seams mocked: @/lib/school-admin-auth (authorizeSchoolAdmin),
 * @/lib/feature-flags (isFeatureEnabled — flag + permission-code selector),
 * @/lib/supabase-server (createSupabaseServerClient — RLS-emulating stub),
 * @/lib/logger.
 *
