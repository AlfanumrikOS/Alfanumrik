...
import { redactPIIInText } from '@/lib/ops-events-redactor';
...
describe('Tier-2 PR B — super-admin export message redaction (P13) — REG-202', () => {
  ...
  describe('redactPIIInText behavior (imported via @/lib/ops-events-redactor)', () => {
  ...
  describe('@/lib/ops-events-redactor barrel exports redactPIIInText', () => {
