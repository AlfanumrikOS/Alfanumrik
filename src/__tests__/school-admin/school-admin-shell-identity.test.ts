...
vi.mock('@/lib/AuthContext', () => ({ useAuth: () => ({ authUserId: null, isHi: false }) }));
...
vi.mock('@/lib/use-school-command-center', () => ({ useSchoolCommandCenter: () => false }));
...
vi.mock('@/components/admin-ui/DashboardSidebar', () => ({ default: () => null }));
