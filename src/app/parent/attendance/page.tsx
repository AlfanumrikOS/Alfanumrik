...
export default function ParentAttendancePage() {
  ...
  if (!authChecked || auth.isLoading) {
    return (
      <div className="font-['Plus_Jakarta_Sans','Sora',system-ui,sans-serif] text-gray-900 min-h-screen bg-[#FFF8F0]">
        <PageSkeleton />
      </div>
    );
  }
  ...
  return (
    <div
      className="font-['Plus_Jakarta_Sans','Sora',system-ui,sans-serif] text-gray-900 min-h-screen bg-[#FFF8F0]"
    >
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
