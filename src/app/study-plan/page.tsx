...
function StudyPlanContent() {
  ...
  const { authUserId, isLoading } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-background px-4 py-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-xl font-bold text-foreground mb-2">Study Plan</h1>
        {examId && (
          <p className="text-sm text-muted-foreground mb-6">Preparing your study plan for exam {examId}…</p>
        )}
