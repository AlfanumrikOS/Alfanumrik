      ...
      <main className="app-container py-5 space-y-4">
        ...
        {loading ? (
          ...
          <div className="space-y-5">
            {/* "No exams in 30 days" banner — only when there's no upcoming exam and no active plan.
                Surfaces /parent/calendar as the canonical place to add an exam date. The 3-question
                wizard below still renders as the fallback path for generating a generic sprint. */}
            {!upcomingExam && !hasPlan && !examLoading && (
              <Card className="!p-4">
                <p className="text-sm font-semibold mb-1">
                  {isHi ? 'अगले 30 दिनों में कोई परीक्षा नहीं है' : 'No exams in the next 30 days'}
                </p>
