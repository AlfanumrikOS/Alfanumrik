...
export default function TeacherProfilePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', paddingBottom: 100 }}>
      ...
      {toast && (
        <div role="alert" style={{ margin: '16px 20px 0', padding: '10px 16px', borderRadius: 10, background: toast.includes('Failed') || toast.includes('must') || toast.includes('too long') ? 'var(--danger-light)' : '#D1FAE5', color: toast.includes('Failed') || toast.includes('must') || toast.includes('too long') ? 'var(--danger)' : '#059669', fontSize: 13, fontWeight: 600, textAlign: 'center' }}>
          {toast}
        </div>
      )}
