...
const QUICK_ACTIONS = [
  { href: '/quiz', icon: '⚡', label: 'Practice', labelHi: 'अभ्यास', color: '#7C3AED' },
  ...
  { href: '/study-plan', icon: '📅', label: 'Plan', labelHi: 'योजना', color: '#F5A623' },
  { href: '/leaderboard', icon: '🏆', label: 'Rank', labelHi: 'रैंक', color: '#DB2777' },
];
