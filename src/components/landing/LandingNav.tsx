    ...
    <>
      <nav
        ...
        style={{
          ...
          background: scrolled
            ? 'rgba(250, 255, 254, 0.88)'
            : 'transparent',
          backdropFilter: scrolled ? 'blur(16px) saturate(180%)' : 'none',
          WebkitBackdropFilter: scrolled ? 'blur(16px) saturate(180%)' : 'none',
          borderBottom: scrolled ? '1px solid rgba(0, 177, 122, 0.06)' : '1px solid transparent',
        }}
      >
        <div
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '0 2px 8px rgba(0, 177, 122, 0.25)',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = '0 4px 20px rgba(0, 177, 122, 0.4)';
                e.currentTarget.style.transform = 'translateY(-1px)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = '0 2px 8px rgba(0, 177, 122, 0.25)';
