...
//
// Existing call sites import from '@/lib/tenant'. We re-export the legacy
// names from this module so new code can switch to '@/lib/tenant/index' (or
// the implicit '@/lib/tenant' once we move the file later) without churn.
