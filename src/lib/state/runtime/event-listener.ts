 ...
 *
 * The daemon-side half of the bus. Reads new rows from domain_events
 ...
 *     domain_events_cursor; restart-safety is "read cursor, resume".
 ...
 *     two domain_events rows for the same key. Subscribers may still
...
const CURSOR_KEY = 'domain_events_watermark';
...
/**
 * Translate a domain_events row (snake_case from PG) into a DomainEvent.
